...
namespace FifthTaskTests
{
    ...
    public class PdfWriterTests
    {
        ...
        /// <summary>
        /// Tests WriteSubscribersAndBooksGroupedByGenre method in pdf
        /// </summary>
        [TestMethod]
        public void WriteSubscribersAndBooksGroupedByGenre_ShouldWriteInformationInTheTextFileAndNotThrowAnException()
        {
            // Arrange
            ...
            // Act
            PDFWriter.WriteSubscribersAndBooksGroupedByGenre($"{Directory.GetCurrentDirectory()}\\SubscribersAndTheirBooksPdfFormat.pdf", BookReportDtoService.GroupBooksOfEachSubscriberByGenre(dateTimeBegin, dateTimeEnd));
        }
        /// <summary>
        /// Tests WriteHowManyTimesBooksWasTaken method in pdf
        /// </summary>
        [TestMethod]
        public void WriteHowManyTimesBooksWasTaken_ShouldWriteToTextFileAndNotThrowAnException()
        {
            // Act
            PDFWriter.WriteHowManyTimesBooksWasTaken($"{Directory.GetCurrentDirectory()}\\BooksUsagePdfFormat.pdf", BookDtoService.CalculateHowManyTimesBooksWasTaken());
