...
namespace FifthTaskTests
{
    ...
    public class ExcelWriterTests
    {
        ...
        /// <summary>
        /// Tests WriteSubscribersAndBooksGroupedByGenre method in excel
        /// </summary>
        [TestMethod]
        public void WriteSubscribersAndBooksGroupedByGenre_ShouldWriteToXlsxFileAndNotThrowException()
        {
            // Arrange
            ...
            // Act
            ExcelWriter.WriteSubscribersAndBooksGroupedByGenre($"{Directory.GetCurrentDirectory()}\\SubscribersAndTheirBooks.xlsx",BookReportDtoService.GroupBooksOfEachSubscriberByGenre(dateTimeBegin, dateTimeEnd));
        }

        /// <summary>
        /// Tests WriteHowManyTimesBooksWasTaken method in excel
        /// </summary>
        [TestMethod]
        public void WriteHowManyTimesBooksWasTaken_ShouldWriteToXlsxFileAndNotThrowException()
        {
            // Act
            ExcelWriter.WriteHowManyTimesBooksWasTaken($"{Directory.GetCurrentDirectory()}\\BooksUsage.xlsx", BookDtoService.CalculateHowManyTimesBooksWasTaken());
