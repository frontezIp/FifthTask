...
{
    [TestClass]
    public class SubscriberDtoServiceTests
    {
        ...
        /// <summary>
        /// Tests GetAllSubscribers method
        /// </summary>
        [TestMethod]
        public void GetAllSubcribers_ShouldReturnAllPossibleSubcribers()
        {
            // Arrange
            bool expected = true;
            bool actual = true;
            ...
            // Act
            List<SubscriberDto> subscriberDtos = SubscriberDtoService.GetAllSubcribers();
            if (subscriberDtos == null || subscriberDtos.Count != 3)
                actual = false;
            // Assert
        ...
        /// <summary>
        /// Tests GetTheMostReadingSubsscriber method
        /// </summary>
        [TestMethod]
        public void GetTheMostReadingSubscriber_ShouldReturnTheMostReadingSubscriber()
        {
            // Arrange
            string expected = "Michael Eliot Jordan";

            // Act
            string actual = SubscriberDtoService.GetTheMostReadingSubscriber();
